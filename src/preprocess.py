...
class TextPreprocessor:
    ...
    def save_preprocessing(self, filename):
        with open(filename, 'wb') as f:
            pickle.dump((self.tokenizer, self.total_words, self.max_sequence_len), f)


    def load_preprocessing(self, filename):
        with open(filename, 'rb') as f:
            self.tokenizer, self.total_words, self.max_sequence_len = pickle.load(f)
